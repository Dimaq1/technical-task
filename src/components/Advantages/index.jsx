      ...
      <ul className='advantages__list'>
        <li className='advantages__list-item'>
          ...
          <div className='advantages__list-item-images'>
            <img className='advantages__list-item-images-star' src={!changeImagesWidth ? "./images/star.svg" : "../../../public/images/star-mobile.svg"} alt="" />
            <img className='advantages__list-item-images-check' src={!changeImagesWidth ? "./images/check.svg" : "../../../public/images/check-mobile.svg"} alt="" />
          </div>
        </li>
        <li className='advantages__list-item'>
